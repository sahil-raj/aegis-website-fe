      ...
      <div className="container mx-auto px-4 py-20 text-white">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            that protect and empower businesses worldwide.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-20">
          <div className="bg-gray-800/50 p-8 rounded-xl backdrop-blur-sm border border-gray-700">
            ...
            <p className="text-gray-300">
              ...
              organizations against evolving digital threats while ensuring
          ...
          <div className="bg-gray-800/50 p-8 rounded-xl backdrop-blur-sm border border-gray-700">
            ...
            <p className="text-gray-300">
              ...
              creating a safer digital world for businesses and individuals
              alike.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-800/30 rounded-2xl p-12 backdrop-blur-sm border border-gray-700">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Unwavering commitment to protecting our clients&apos; digital
                assets.
              </p>
            </div>
            <div className="text-center">
